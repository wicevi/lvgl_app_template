...
#  define USE_MOUSEWHEEL      (SIMULATOR == 1)
#endif
...
/*DEPRECATED: Use the SDL driver instead. */
#ifndef USE_KEYBOARD
#  define USE_KEYBOARD        (SIMULATOR == 1)
#endif
